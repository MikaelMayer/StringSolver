...
class TempTests  extends FlatSpec with ShouldMatchers {
  ...
  "Your test" should "work faster" in {
    ...
    NEW
		"a.doc,b.pdf,c.doc,d.jpg" ==> ("a.doc", "b.pdf", "...")
		val split = SPLIT
		NEW
		"myfile.doc" ==> "doc/Myfile01.doc"
		"other.file.pdf" ==> "pdf/Other.file02.pdf"
		val rename = MAP
    (split andThen rename)("a.doc,b.pdf") should equal (List("doc/A01.doc", "pdf/B02.pdf"))
